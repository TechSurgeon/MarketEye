...
public class SecuritiesUpdateManager extends Thread{

	private static SecuritiesManager sm = new SecuritiesManager();
	
	private static Logger logger = Logger.getLogger("SecuritiesUpdateManager");
	...
	public SecuritiesUpdateManager(){
	...
	public void run(){
		...
		while(!exit.equals("q")){
			...
			if(exit.equals("u")){
				logger.info("Received order to update. About to update.");
				
				logger.info("Loading Security Symbols in Database.");
				securities = PersistDBUtil.loadSecurities();
				//logger.info(securities.size()+" Security Symbols found in System.");
				activeSecurities = SecuritiesUpdateManager.updateActiveSecurities();
				count = hm.updateDailyDataForAllActiveSecurities(activeSecurities);
				//HDParser.
				//HistoricalDataManager.
				
				
				logger.info("Done updating daily data. ("+count+")");
			}
			if(exit.equals("q")){
				logger.info("Received order to shutdown. Good bye!");
			}
	...
	public static void main(String[] args){
		// running thread, updating after every market day at specific time
		
		SecuritiesUpdateManager runner = new SecuritiesUpdateManager();
